...
navLinks.forEach(link => {
    link.addEventListener('click', (e) => {
        ...
        // Kalau link menuju halaman lain (bukan anchor #), biarkan berfungsi normal
        if (!targetId.startsWith('#')) {
            return; // Skip preventDefault, biarkan link berfungsi normal
        }
        
        // Kalau link anchor (#), baru gunakan smooth scroll
        e.preventDefault();
